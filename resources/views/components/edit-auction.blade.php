            ...
            <form method="POST" files="true" enctype="multipart/form-data">
                ...
                <div class="col d-flex justify-content-end align-items-end">
                    ...
                    @if(Route::currentRouteName() == 'userAuctions' || Auth::user()->is_admin())
                        <button type="button" id="deleteButton" name="deleteItem" value="true" class="btn btn-danger inv_after_approved m-1" style="height: 40px;" data-target="{{ route('deleteAuction') }}">Smazat</button>
                    @endif
                </div>
            </form>
        </div>
