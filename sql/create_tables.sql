...
CREATE TABLE `user` (
    ...
    `surname`          varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `auction` (
    ...
    KEY `buyer_fk` (`buyer`),
    KEY `item_fk` (`item`),
    CONSTRAINT `buyer_fk` FOREIGN KEY (`buyer`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `item_fk` FOREIGN KEY (`item`) REFERENCES `auction_item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `seller_fk` FOREIGN KEY (`seller`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `participant_of` (
    ...
    CONSTRAINT `part_fk` FOREIGN KEY (`participant`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `auctioneer_of` (
    ...
    CONSTRAINT `auctioneer_fk` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
